...
export const UserSchema = z.object({
  ...
  email: z.email("validation.errors.invalid_email"),
  hash: z.string().min(10, "validation.errors.string_too_short").max(100, "validation.errors.string_too_long"),
  role: z.string().min(1, "validation.errors.field_empty"),
